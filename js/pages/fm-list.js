...
class FMListPage {
    ...
    async render() {
        ...
        document.getElementById('headerSubtitle').textContent = 'Werkzeugübersicht';
                ...
                <div class="controls">
                    ...
                    <div class="filter-section">
                        ...
                        <div class="filter-chip" data-filter="in-inventur">
                            in Inventur <span class="count" id="countInInventur">0</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-container">
                    ...
                    <div class="pagination">
                        ...
                        <div class="pagination-controls">
                            <button class="page-btn" id="prevPage" onclick="fmListPage.prevPage()">◀ Zurück</button>
                            <button class="page-btn" id="nextPage" onclick="fmListPage.nextPage()">Weiter ▶</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    async loadData() {
        try {
            const response = await api.getFMList();
            if (response.success) {
            ...
            console.error('Error loading FM data:', error);
    ...
    renderTable() {
                ...
                <tr>
                    <td colspan="7">
                        <div class="empty-state">
                            ...
                            <div class="empty-state-text">Keine Werkzeuge gefunden</div>
        ...
        document.getElementById('paginationInfo').textContent =
            `Zeige ${startIdx + 1}-${Math.min(endIdx, this.filteredTools.length)} von ${this.filteredTools.length} Werkzeugen`;
...
const fmListPage = new FMListPage();
