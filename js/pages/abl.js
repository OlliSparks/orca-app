...
class ABLPage {
    ...
    async render() {
                ...
                <div class="controls">
                    <div class="search-bar">
                        <input
                            ...
                            class="search-input"
                            id="searchInput"
                            placeholder="🔍 Suche nach ABL-Nr., Name, Lieferant oder Standort..."
                        >
                        <button class="btn btn-secondary" onclick="ablPage.loadFromAPI()">
                            🔄 API Laden
                        </button>
        ...
        document.getElementById('footerActions').innerHTML = `
            <button class="btn btn-neutral" onclick="ablPage.showSettings()">⚙️ Einstellungen</button>
            <button class="btn btn-primary" onclick="ablPage.showAddModal()">➕ Neuer ABL-Auftrag</button>
        `;
    ...
    renderTable() {
        ...
        document.getElementById('paginationInfo').textContent =
            `Zeige ${startIdx + 1}-${Math.min(endIdx, this.filteredTools.length)} von ${this.filteredTools.length} ABL-Aufträgen`;
    ...
    showAddModal() {
        alert('➕ ABL-Auftrag Hinzufügen - Diese Funktion wird später implementiert');
    }
